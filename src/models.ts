...
export const MODEL_TIERS = ['ultra', 'heavy', 'standard', 'light', 'nano'] as const;
...
export function getCheapestModel(tier: ModelTier): ModelDefinition | undefined {
...
export function getPricingSummary(): string {
  const lines: string[] = ['Model Pricing (per 1M tokens):', ''];
